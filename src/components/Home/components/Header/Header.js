            ...
            <div className="header__heroContainer">
              <Content>
                <div className="header__heroContent">
                  <h2 className="header__heroHeading">
                    Promoting open source, one step at a time
                  </h2>
                  <p className="header__heroSubheading">
                    At IOSF we have taken a pledge to make open source
                    contribution simplified. Join us in our journey and let's
                    create effective products on our way.
                  </p>
                </div>
                <div className="header__btnContainer">
                  <Button
                    className="header__heroJoinUsBtn"
                    size="medium"
                    renderAs="a"
                  ...
                  <Button
                    className="header__heroOurProductsBtn"
                    onClick={() => this.handleClick("products__section")}
                    size="medium"
                  >
                    OUR PRODUCTS
                  </Button>
            ...
            <Columns className="togetherLets__cardContainer">
              <Columns.Column className="togetherLets__card">
                <Content>
                  ...
                  <h3>Learn</h3>
                  <p>
                    There's always a room for learning here. We are constantly
                    learning new skills and concepts at all levels which help us
              ...
              <Columns.Column>
                <Content>
                  ...
                  <h3>Contribute</h3>
                  <p>
                    An active community of contributors that are passionate
                    about product development and want to create something big.
                  </p>
                </Content>
              </Columns.Column>
              <Columns.Column>
                <Content>
                  ...
                  <h3>Mentor</h3>
                  <p>
                    IOSF loves mentoring sessions. It gives us an opportunity to
                    share knowledge amongst fellow developers and encourage them
